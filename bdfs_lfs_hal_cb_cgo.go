...
int go_bdfs_read(uintptr_t fs, lfs_block_t block, lfs_off_t off, void *buffer, lfs_size_t size);
int go_bdfs_prog_page(uintptr_t fs, lfs_block_t block, lfs_off_t off, const void *buffer, lfs_size_t size);
